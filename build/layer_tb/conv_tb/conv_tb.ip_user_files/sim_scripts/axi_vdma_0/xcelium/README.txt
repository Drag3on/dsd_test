...
#
# Generated by export_simulation on Thu Dec 07 14:41:25 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './axi_vdma_0.sh' script.

./axi_vdma_0.sh -reset_run
...
./axi_vdma_0.sh -noclean_files

For more information on the script, please type './axi_vdma_0.sh -help'.
