...
HD_PWD='C:/Users/Jsangwook/Desktop/DSD_Project/dsd-final-project-team11/build/layer_tb/pool_tb/pool_tb.runs/axi_vdma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_vdma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_vdma_0.tcl
