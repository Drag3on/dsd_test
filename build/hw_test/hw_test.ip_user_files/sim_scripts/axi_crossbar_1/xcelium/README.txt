...
#
# Generated by export_simulation on Sat Dec 02 17:23:41 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './axi_crossbar_1.sh' script.

./axi_crossbar_1.sh -reset_run
...
./axi_crossbar_1.sh -noclean_files

For more information on the script, please type './axi_crossbar_1.sh -help'.
