...
#
# Generated by Vivado on Sat Dec 02 17:24:12 +0900 2023
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_gen xil_defaultlib.clk_gen xil_defaultlib.glbl -log elaborate.log
}
