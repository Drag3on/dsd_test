...
HD_PWD='C:/Users/Jsangwook/Desktop/DSD_Project/dsd-final-project-team11/build/hw_test/hw_test.runs/axi_crossbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_crossbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_crossbar_1.tcl
